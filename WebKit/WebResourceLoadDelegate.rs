...
pub unsafe trait WebResourceLoadDelegate: NSObjectProtocol {
    ...
    #[objc2::method(
        optional,
        sel = "webView:identifierForInitialRequest:fromDataSource:",
        managed = "Other"
    )]
    ...
    #[objc2::method(
        optional,
        sel = "webView:resource:willSendRequest:redirectResponse:fromDataSource:",
        managed = "Other"
    )]
    ...
    #[objc2::method(
        optional,
        sel = "webView:resource:didReceiveAuthenticationChallenge:fromDataSource:"
    )]
    ...
    #[objc2::method(
        optional,
        sel = "webView:resource:didCancelAuthenticationChallenge:fromDataSource:"
    )]
    ...
    #[objc2::method(optional, sel = "webView:resource:didReceiveResponse:fromDataSource:")]
    ...
    #[objc2::method(
        optional,
        sel = "webView:resource:didReceiveContentLength:fromDataSource:"
    )]
    ...
    #[cfg(all(feature = "WebKit_WebDataSource", feature = "WebKit_WebView"))]
    #[objc2::method(optional, sel = "webView:resource:didFinishLoadingFromDataSource:")]
    ...
    #[objc2::method(
        optional,
        sel = "webView:resource:didFailLoadingWithError:fromDataSource:"
    )]
    ...
    #[objc2::method(optional, sel = "webView:plugInFailedWithError:dataSource:")]
