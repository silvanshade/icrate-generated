...
pub unsafe trait WebPolicyDecisionListener: NSObjectProtocol {
    #[objc2::method(sel = "use")]
    unsafe fn r#use(&self);

    #[objc2::method(sel = "download")]
    unsafe fn download(&self);

    #[objc2::method(sel = "ignore")]
...
pub unsafe trait WebPolicyDelegate: NSObjectProtocol {
    ...
    #[objc2::method(
        optional,
        sel = "webView:decidePolicyForNavigationAction:request:frame:decisionListener:"
    )]
    ...
    #[objc2::method(
        optional,
        sel = "webView:decidePolicyForNewWindowAction:request:newFrameName:decisionListener:"
    )]
    ...
    #[objc2::method(
        optional,
        sel = "webView:decidePolicyForMIMEType:request:frame:decisionListener:"
    )]
    ...
    #[objc2::method(optional, sel = "webView:unableToImplementPolicyWithError:frame:")]
