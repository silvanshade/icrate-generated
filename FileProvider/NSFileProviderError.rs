...
extern "Objective-C" {
    ...
    #[objc2::method(sel = "fileProviderErrorForCollisionWithItem:", managed = "Other")]
    pub unsafe fn fileProviderErrorForCollisionWithItem(
        existing_item: &NSFileProviderItem,
    ) -> Id<Self>;

    #[objc2::method(
        sel = "fileProviderErrorForNonExistentItemWithIdentifier:",
        managed = "Other"
    )]
    ...
    #[objc2::method(sel = "fileProviderErrorForRejectedDeletionOfItem:", managed = "Other")]
